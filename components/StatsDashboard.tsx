...
export default function StatsDashboard({ datasets }: { datasets: StatsDataset[] }) {
    ...
    return <main className="space-y-8">
        ...
        <section className="overflow-hidden rounded-xl border border-slate-700 bg-slate-900 shadow-sm">
            <div className="border-b border-slate-700 px-5 py-4"><h2 className="text-lg font-bold text-slate-100">Odds performance</h2><p className="mt-1 text-sm text-slate-400">Average odds are calculated on the continuous decimal scale, then displayed as standard American odds. Actual vs. implied is the player&apos;s win rate minus the average implied probability of their picks.</p></div>
